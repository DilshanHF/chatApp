package lk.ijse.GroupchatApplication.client;
...
import lk.ijse.GroupchatApplication.controller.ClientRoomController;
...
public class Client implements Runnable, Serializable {
        ...
        while (true) {
            try {
                ...
                if (message.equals("*image*")) {
                   ...
                   clientRoomController.writeMessage(message);
                }
            } catch (IOException e) {
                try {
                    inputStream.close();
    ...
    private void loadScene() throws IOException {
        ...
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/view/clientRoom.fxml"));
        Parent parent = loader.load();
        clientRoomController = loader.getController();
        clientRoomController.setClient(this);
    ...
    private void receiveImage() throws IOException {
        ...
        clientRoomController.setImage(bytes, utf);
    }
